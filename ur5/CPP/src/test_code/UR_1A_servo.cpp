...
const int SERVO1_MIN = 45; // Minimum position for servo1
const int SERVO1_MAX = 110; // Maximum position for servo1
const int SERVO2_MIN = 45; // Minimum position for servo2
const int SERVO2_MAX = 130; // Maximum position for servo2

int pos = 90; // Initial position for servos
int position2;
