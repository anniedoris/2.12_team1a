...
const uint8_t controllerAddr[] = {0xEC, 0xDA, 0x3B, 0x41, 0xB6, 0xCC}; //changed to our controller
const uint8_t robotAddr[] = {0xEC, 0xDA, 0x3B, 0x41, 0xB5, 0x9C}; //changed to our robot (robot 1)
//const uint8_t robotAddr[] = {0xF4, 0x12, 0xFA, 0x40, 0x99, 0xF0}; //(for robot 2 bigger one)
